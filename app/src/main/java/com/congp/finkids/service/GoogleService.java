package com.congp.finkids.service;
...
/**
 * Created by congphuong on 24/10/17.
 */
...
public class GoogleService extends Service implements LocationListener {
    ...
    public void onCreate() {
        super.onCreate();
        this.apiService = ApiUtils.getIapiService();
...
//        fn_getlocation();
    ...
    private void fn_update(Location location) {
        ...
        if(!email.equals("")){
            apiService.insertCurentLocation("insert-curent-location",
                    email, String.valueOf(latitude), String.valueOf(longitude))
